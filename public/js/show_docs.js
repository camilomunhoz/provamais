    ...
    function showDetails(e) {
        ...
        $('#doc-details').append(
            ...
            '<div id="doc-actions">'+
                ...
                '<a id="pdf" class="doc-action" href="/pdf/'+docId+'" alt="Gerar PDF" title="Gerar PDF" target="_blank">'+
                    '<img src="/img/icons/ico_pdf.svg">'+
                    '<span>Gerar PDF</span>'+
                '</a>'+

                '<a id="answers" class="doc-action" href="/pdf/'+docId+'/answers" alt="Gabarito" title="Gabarito" target="_blank">'+
